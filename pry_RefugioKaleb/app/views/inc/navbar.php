        ...
        <img src="app/views/img/logo.png" alt="" width="60" height="70"  class="d-inline-block align-text-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-warning  margin-right: 2px" href="<?php echo APP_URL;?>register/" id="navbarDropdown">Registrate</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-warning " href="<?php echo APP_URL;?>login/" id="navbarDropdown">Inicia Sesión</a>
                    </li>
                </ul>
            </div>
        </div>
